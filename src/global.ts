...
export const GROUP_DICT = {
    ...
    // "短租":HsyGroupEnum.ShortTerm,
    // "测试":HsyGroupEnum.TestGroup,
    "测试群1":HsyGroupEnum.TestGroup,
    "测试群0": HsyGroupEnum.BigTeam
};
...
export const hsyReferMsg = `欢迎访问http://jogchat.com加北美各地群`;
...
export const greetingsMsg = `你好，谢谢你加我们群;请回复要加哪个群，例如:测试群0，测试群1`;
...
export const hysAlreadyAddedMsg = `已邀请，请点击加入[小助手]系列群。`;

export const hsyGroupNickNameMsg = `已邀请，请点击加入[小助手]系列群。`;
